...
def train_and_test_model(X_train, X_valid, X_test, Y_train, Y_valid, Y_test, list_possible_materials, layers_to_not_freeze,
    ...
    checkpoint = ModelCheckpoint(
        os.path.join(weights_directory, "weights_mobilenet_1024_notfrozen_" + str(layers_to_not_freeze) + "_lr_" + str(learning_rate) + "_dropout_" + str(dropout) + "_batch_size_" + str(batch_size) + ".h5"),
    ...
    with open(os.path.join(results_directory, "history_mobilenet_1024_notfrozen_" + str(layers_to_not_freeze) + "_lr_" + str(learning_rate) + "_dropout_" + str(dropout) + "_batch_size_" + str(batch_size) + ".json"),
              "w") as json_file:
    ...
    text_file = open(os.path.join(test_directory, "test_mobilenet_1024_notfrozen_" + str(layers_to_not_freeze) + "_lr_" + str(learning_rate) + "_dropout_" + str(dropout) + "_batch_size_" + str(batch_size) + ".txt"), "w")
