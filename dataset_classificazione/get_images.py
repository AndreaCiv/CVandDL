...
if __name__ == "__main__":
    ...
    file_name_en_cn_men = "/dataset_non_completo_cv/en-cn/men/en-cn_men_mytheresa.json"
    file_name_en_cn_women = "/dataset_non_completo_cv/en-cn/women/en-cn_women_mytheresa.json"

    file_name_en_it_men = "/dataset_non_completo_cv/en-it/men/en-it_men_mytheresa.json"
    file_name_en_it_women = "/dataset_non_completo_cv/en-it/women/en-it_women_mytheresa.json"

    file_name_en_jp_men = "/dataset_non_completo_cv/en-jp/men/en-jp_men_mytheresa.json"
    file_name_en_jp_women = "/dataset_non_completo_cv/en-jp/women/en-jp_women_mytheresa.json"

    file_name_en_kr_men = "/dataset_non_completo_cv/en-kr/men/en-kr_men_mytheresa.json"
    file_name_en_kr_women = "/dataset_non_completo_cv/en-kr/women/en-kr_women_mytheresa.json"

    file_name_en_us_men = "/dataset_non_completo_cv/en-us/men/en-us_men_mytheresa.json"
    file_name_en_us_women = "/dataset_non_completo_cv/en-us/women/en-us_women_mytheresa.json"
